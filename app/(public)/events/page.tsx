...
export default function EventsPage() {
  return (
    <>
      <HeroFull imageSrc="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1920&q=80" imageAlt="Corporate retreat dinner on the Rivers Lodge estate lawn at dusk" eyebrow="Events & Retreats" headline="Private events for the people and companies that matter." subline="A property that changes the quality of the conversation." height="large" actions={[{ label: 'Corporate Retreats', href: '/events/corporate-retreats', variant: 'ghost-dark' }, { label: 'Private Events', href: '/events/private-events', variant: 'ghost-dark' }]} />
      <Section background="cream">
        <Container width="layout">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[{ src: 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=800&q=80', alt: 'Team in the lodge great room', label: 'Corporate Retreats', sublabel: 'For teams and companies', href: '/events/corporate-retreats', headline: 'Corporate Retreats', body: 'The estate accommodates full corporate buyouts — overnight lodging, dedicated event spaces, catering coordination, and outdoor programming.', cta: 'Explore retreats' }, { src: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80', alt: 'Dinner party setup in the lodge', label: 'Private Events', sublabel: 'Gatherings and celebrations', href: '/events/private-events', headline: 'Private Events', body: 'Milestone birthdays, family reunions, private dinners, anniversary celebrations. The lodge and grounds available for exclusive buyout.', cta: 'Explore private events' }].map(({ src, alt, label, sublabel, href, headline, body, cta }) => (
              <div key={href}>
