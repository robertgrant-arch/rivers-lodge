...
const SEASONS = [
  { label: 'Whitetail Deer', period: 'September — January', description: 'The property holds a healthy resident herd. Managed stands throughout the timber and field edges, with cell cam monitoring updated to the member portal throughout the season.', imageSrc: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', imageAlt: 'Whitetail buck in the south field at dusk', status: 'open' as const },
  { label: 'Waterfowl', period: 'November — February', description: 'The Marais des Cygnes corridor is a natural migration flyway. Blind access, decoy equipment, and guided options available to members through the peak of the migration.', imageSrc: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', imageAlt: 'Duck marsh at sunrise', status: 'open' as const },
  { label: 'Turkey', period: 'April — May', description: 'Spring turkey on the property is a genuine experience. The timber edges and food plots concentrate birds. Walk-in access with guide options available.', imageSrc: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', imageAlt: 'Tom turkey in the field at sunrise', status: 'upcoming' as const },
  { label: 'Fishing', period: 'Year-round', description: 'The Marais des Cygnes holds largemouth bass, channel catfish, and crappie year-round. Bank access and guided float options available to members.', imageSrc: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', imageAlt: 'Fishing on the Marais des Cygnes River', status: 'open' as const },
]
const PRIVILEGES = [
