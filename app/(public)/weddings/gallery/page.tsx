...
const CEREMONY: GalleryImage[] = [{ src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Ceremony arch with river in background', featured: true }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Processional on the River Lawn' }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Couple exchanging vows' }]
const RECEPTION: GalleryImage[] = [{ src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Reception tables in the Pavilion', featured: true }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'First dance under the open Pavilion' }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Wedding cake detail' }]
const DETAILS: GalleryImage[] = [{ src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Wedding rings on a wildflower bouquet' }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Floral centerpiece with seasonal blooms' }]
const GROUNDS: GalleryImage[] = [{ src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'First look on the lodge terrace', featured: true }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Couple portrait in the timber edge at sunset' }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Sparkler send-off at dusk' }]
