...
const VENUE_SPACES: VenueSpace[] = [
  { name: 'The River Lawn', type: 'outdoor', ceremonyCapacity: 200, receptionCapacity: 180, description: 'A level grass expanse with direct sightlines to the Marais des Cygnes. The natural backdrop for an outdoor ceremony — open sky, the river, and nothing competing with the moment.', imageSrc: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', imageAlt: 'Ceremony on the River Lawn' },
  { name: 'The Timber Edge', type: 'outdoor', ceremonyCapacity: 120, description: 'Where the open field meets the tree line. A naturally framed space with dappled light and a sense of enclosure that larger venues cannot manufacture.', imageSrc: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', imageAlt: 'Ceremony arch at the edge of the timber' },
  { name: 'The Event Pavilion', type: 'both', receptionCapacity: 200, description: 'A covered structure designed to bridge indoors and out. Configured for seated dining, dancing, or standing receptions.', imageSrc: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', imageAlt: 'Event Pavilion set for an evening reception' },
]
const GALLERY_IMAGES: GalleryImage[] = [
  { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Ceremony at the River Lawn', featured: true }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Ring detail on a wildflower bouquet' },
  { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Reception tables at golden hour' }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'First look on the lodge terrace' },
  { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Couple dancing under the pavilion' }, { src: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80', alt: 'Sparkler send-off at dusk' },
]
export default function WeddingsPage() {
  return (
    <>
      <HeroFull imageSrc="https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80" imageAlt="Ceremony at Rivers Lodge at golden hour" eyebrow="Weddings at Rivers Lodge" headline="Your wedding, without compromise." subline="An estate that holds the day as beautifully as you imagined it." height="full" showScroll actions={[{ label: 'Check Availability', href: '#availability', variant: 'ghost-dark' }, { label: 'Begin Inquiry', href: '/weddings/inquire', variant: 'ghost-dark' }]} />
