...
const VENUE_SPACES: VenueSpace[] = [
  { name: 'The River Lawn', type: 'outdoor', ceremonyCapacity: 200, receptionCapacity: 180, description: 'A level grass expanse with direct sightlines to the Marais des Cygnes. The natural backdrop for an outdoor ceremony — open sky, the river, and nothing competing with the moment.', imageSrc: '/images/weddings/venues/river-lawn.jpg', imageAlt: 'Ceremony on the River Lawn' },
  { name: 'The Timber Edge', type: 'outdoor', ceremonyCapacity: 120, description: 'Where the open field meets the tree line. A naturally framed space with dappled light and a sense of enclosure that larger venues cannot manufacture.', imageSrc: '/images/weddings/venues/timber-edge.jpg', imageAlt: 'Ceremony arch at the edge of the timber' },
  { name: 'The Event Pavilion', type: 'both', receptionCapacity: 200, description: 'A covered structure designed to bridge indoors and out. Configured for seated dining, dancing, or standing receptions.', imageSrc: '/images/weddings/venues/event-pavilion.jpg', imageAlt: 'Event Pavilion set for an evening reception' },
]
const GALLERY_IMAGES: GalleryImage[] = [
  { src: '/images/weddings/gallery/ceremony-1.jpg', alt: 'Ceremony at the River Lawn', featured: true }, { src: '/images/weddings/gallery/details-1.jpg', alt: 'Ring detail on a wildflower bouquet' },
  { src: '/images/weddings/gallery/reception-1.jpg', alt: 'Reception tables at golden hour' }, { src: '/images/weddings/gallery/first-look.jpg', alt: 'First look on the lodge terrace' },
  { src: '/images/weddings/gallery/dancing.jpg', alt: 'Couple dancing under the pavilion' }, { src: '/images/weddings/gallery/departure.jpg', alt: 'Sparkler send-off at dusk' },
]
export default function WeddingsPage() {
  return (
    <>
      <HeroFull imageSrc="/images/weddings/hero.jpg" imageAlt="Ceremony at Rivers Lodge at golden hour" eyebrow="Weddings at Rivers Lodge" headline="Your wedding, without compromise." subline="An estate that holds the day as beautifully as you imagined it." height="full" showScroll actions={[{ label: 'Check Availability', href: '#availability', variant: 'ghost-dark' }, { label: 'Begin Inquiry', href: '/weddings/inquire', variant: 'ghost-dark' }]} />
